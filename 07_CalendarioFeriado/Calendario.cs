...
namespace _06_calendario
{
    internal class Calendario
    {
                ...
                for (int diaSemana = 0; diaSemana < 7; diaSemana++)
                {
                    if (calendario[semana, diaSemana] != 0)
                    {
                       /* ehferiado = false;
                        ...
                        for (int posiçãoFeriados = 0; posiçãoFeriados < diasFeriados.Length; posiçãoFeriados++)
                        {
                            if (diasFeriados[posiçãoFeriados] != null && diasFeriados[posiçãoFeriados].Dia == calendario[semana, diaSemana])
                            {
                                ehferiado = true;
                                break;
                            }
        ...
        private Feriado[] RetornaFeriados()
        {
            ...
            else if (mes == 7) feriados[indice++] = new Feriado(9, "Revolução constitucional de São Paulo");
            else if (mes == 9) feriados[indice++] = new Feriado(7, "Indepedencia do Brasil");
            ...
            else if (mes == 11)
            {
                ...
                feriados[indice++] = new Feriado(20, "Conciencia Negra");
            }
            else if (mes == 12)
            {
                feriados[indice++] = new Feriado(8, "Padrueira da Cidade");
            ...
            if (domingoDePascoa.Month == mes)
                feriados[indice++] = new Feriado(domingoDePascoa.Day, "Pascoa"); 
            ...
            if (CorpuChrist.Month == mes)
                feriados[indice++] = new Feriado(CorpuChrist.Day, "CorpuChrist");
